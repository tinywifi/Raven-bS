...
public class C08 extends CPacket {
    ...
    public C08PacketPlayerBlockPlacement convert() {
        return new C08PacketPlayerBlockPlacement(Vec3.getBlockPos(this.pos), this.direction, this.itemStack != null ? this.itemStack.itemStack : null, (float) this.offset.x, (float) this.offset.y, (float) this.offset.z);
    }
}
